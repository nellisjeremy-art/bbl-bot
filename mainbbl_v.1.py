...
# original code has token stored in file - client.run("discord token")
#below allows us to store the token safely on Render. Then it will plug in token to script
import os
